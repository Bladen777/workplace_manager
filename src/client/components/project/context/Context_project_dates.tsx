...
export interface Types_department_dates {
    [key:string]:{
...
interface Types_context_content {   
    start_date: string | undefined;
    finish_date:string | undefined;
    departments:Types_department_dates
};
...
interface Types_context_function {   
    ...
    all_dates?: Types_context_content;
};
...
export function Provide_Context_project_dates({children}:{children:ReactNode}) {
    ...
    // UPDATE THE CONTEXT 
    async function update_context({ dep_id, date_type, date, all_dates  }:Types_context_function){
